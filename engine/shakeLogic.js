...
const keys = ['age','product','theme','mood','character','mascot','ethnicity','hairstyle','expression','fashion','artStyle','pose','typography','palette','composition','material','production','sizing','intensity']
